...
gulp.task('build-css', function () {
  return gulp.src(conf.paths.assets + '/tmp/css/core.css')
		.pipe($.replace('/assets/libs/font-awesome/fonts', '/assets/fonts'))
		.pipe($.minifyCss())
...
gulp.task('build-html', function () {
	...
	var injectOption = { ignorePath: conf.paths.dist, removeTags: true };
...
gulp.task('build', ['build-fonts', 'build-css', 'build-css-vendor', 'build-js-vendor', 'build-js', 'build-template', 'build-html']);
